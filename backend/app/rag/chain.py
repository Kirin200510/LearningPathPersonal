...
from app.schemas.rag import RagQuestionResponse
...
def get_rag_chain():
    ...
    parser = PydanticOutputParser(pydantic_object=RagQuestionResponse)
    rag_chain = (
            {
            ...
            | llm
            | parser
            | RunnableLambda(lambda result: result.model_dump())
    )
    chain_with_history = (
